...
public class RestricaoEntradaController extends BaseServico {
	...
	@GetMapping("/listarAutorizacao")
	public ResponseEntity<EnumSet<AutorizacaoEnum>>  listarSituacoes(){
		
		return new ResponseEntity<EnumSet<AutorizacaoEnum>>(EnumSet.of(AutorizacaoEnum.PERMITIDA, AutorizacaoEnum.REJEITADA, AutorizacaoEnum.SEM_PROVIDENCIA), HttpStatus.OK);
	}
