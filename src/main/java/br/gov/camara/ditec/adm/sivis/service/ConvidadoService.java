		...
		convidados.forEach(convidado -> {
			if (convidado != null) {
				...
				if(visitanteDTO != null) {
					...
					convidadoDTO.setNomeConvidado(visitanteDTO.getNomeVisitante());
					convidadoDTO.setCpf(visitanteDTO.getCpf());
					convidadoDTO.setTelefone(visitanteDTO.getTelefoneVisitante());
				}
